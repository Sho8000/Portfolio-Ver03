...
export const MainDBJap = [
  {
    ...
    project:[
      ...
      },
      {
        ...
        imgUrl:PokemonImg,
        type:"Personal Project",
        explain:"APIとGSAPの組み合わせを理解するために作りました。API情報を取得するときに、どのように取得した情報にアニメーションを追加するかがはっきりわかっていなかったのですが、このプロジェクトを通して理解することができました。",
        url:"https://sho8000.github.io/Pokemon-Valorant/",
        githubUrl:"",
        skillImg:[GSAP_Logo,JQuery_Logo],
        skillName:["GSAP","JQuery"],
    ...
    workExperience:[
      {
        companyName:"Norsat Intarnational",
        companyImg:NorsatImg,
        contents:"私はここで生産技術者として勤務しています。前職の経験から、電気回路や図面に対しての知識があったため、製品検査や組み立てだけでなく、製品トラブルシューティングも行っています。",
        dateStarted:"Febraly, 2024",
        dateEnded:""
      },
      {
        companyName:"HORIBA STEC",
        companyImg:HoribaImg,
        contents:"私は、この会社に13年間勤務していました。この会社では、生産部門、顧客対応部門、社員や顧客への製品教育、生産の効率化やチームマネジメント等、様々なことを担当していました。特に改善やトラブルシューティングは得意で、生産工程の無駄取りや改善、社内／客先でのトラブルシューティング等、チーム／会社の代表として問題点の提示や説明、対応を進めていました。",
        dateStarted:"April, 2010",
        dateEnded:"June, 2023"
      },
    ],
